// https://yrglset-server.herokuapp.com/api/goals/2020
...
export const fetchGoalsByYear = year => {
  ...
  return axios
    .get("https://yrglset-server.herokuapp.com/api/goals/" + year)
    .then(({ data: { goals } }) => {
      return goals;
    });
};
...
export const addNewGoal = (newGoal, year) => {
  ...
  return axios
    .post(`https://yrglset-server.herokuapp.com/api/goals/${year}`, newGoal)
    .then(({ data: { newGoal } }) => {
      return newGoal;
    });
};
...
export const removeItem = entry => {
  ...
  return axios
    .delete(`https://yrglset-server.herokuapp.com/api/goals/${entry.year}`, {
...
export const completeGoal = (completedGoal, thoughts, year) => {
  return axios
    .patch(`https://yrglset-server.herokuapp.com/api/goals/${year}`, {
